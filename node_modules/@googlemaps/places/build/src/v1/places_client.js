 ...
 */
const gapicConfig = require("./places_client_config.json");
...
class PlacesClient {
    ...
    _universeDomain;
    _servicePath;
    _log = google_gax_1.loggingUtils.log('places');
    auth;
    descriptors = {
        page: {},
        stream: {},
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            photoPathTemplate: new this._gaxModule.PathTemplate('places/{place}/photos/{photo}'),
            photoMediaPathTemplate: new this._gaxModule.PathTemplate('places/{place_id}/photos/{photo_reference}/media'),
            placePathTemplate: new this._gaxModule.PathTemplate('places/{place_id}'),
            reviewPathTemplate: new this._gaxModule.PathTemplate('places/{place}/reviews/{review}'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.maps.places.v1.Places', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.placesStub = this._gaxGrpc.createStub(this._opts.fallback ?
            this._protos.lookupService('google.maps.places.v1.Places') :
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            this._protos.google.maps.places.v1.Places, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const placesStubMethods = ['searchNearby', 'searchText', 'getPhotoMedia', 'getPlace', 'autocompletePlaces'];
        for (const methodName of placesStubMethods) {
            const callPromise = this.placesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    searchNearby(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    searchText(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getPhotoMedia(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    getPlace(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    autocompletePlaces(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=places_client.js.map